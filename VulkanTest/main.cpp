...
private:
  ...
  void pickPhysicalDevice() {
    ...
    std::cout << "supported devices found: " << deviceCount << std::endl;
  ...
  bool isDeviceSuitable(VkPhysicalDevice device) {
    ...
    std::cout << "    Supports geometry shaders: " << deviceFeatures.geometryShader << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "Family queue found: " << indices.isComplete() << std::endl;
    std::cout << "Extensions supported: " << extensionsSupported << std::endl;
    std::cout << "Swap chain supported: " << extensionsSupported << std::endl;
  ...
  void createLogicalDevice() {
    ...
    VkPhysicalDeviceFeatures deviceFeatures = {}; // Everything to VK_FALSE
  ...
  VkPresentModeKHR chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
    for (const auto& availablePresentMode : availablePresentModes) {
      if (availablePresentMode == VK_PRESENT_MODE_MAILBOX_KHR) {
        std::cout << "Triple buffering supported!" << std::endl;
  ...
  void createGraphicsPipeline() {
    ...
    // Clean up shaders after the graphic pipeline is created
  ...
  void createInstance() {
    ...
    std::cout << "Available extensions (GLFW):" << std::endl;
